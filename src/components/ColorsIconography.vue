<template>
   <div class="container bor-style-solid perma container2">
      <p class="m-2 fs-24 fw-bold border-bottom">Colors</p>
      <div class="row ">
   ...
   <div class="container bor-style-solid perma container3">
      <p class="m-2 fs-24 fw-bold border-bottom">Iconography</p>
      
      <div class="row ">
         <div class="d-flex justify-content-start">
            <!-- Row 1  -->
            <i class="icon-size m-2 gray isax isax-home-2"></i>
            <!-- icon2  -->
            <i class="icon-size m-2 gray isax isax-chart-3"></i>
            <!-- icon3  -->
            <i class="icon-size m-2 gray isax isax-bank"></i>
            <!-- icon4  -->
            <i class="icon-size m-2 gray isax isax-setting-2"></i>
            <!-- icon5  -->
            <i class="icon-size m-2 gray isax isax-call"></i>
            <!-- icon6  -->
            <i class="icon-size m-2 gray isax isax-logout"></i>
         </div>
         <!-- Row 2  -->
         <div class="d-flex justify-content-start">
            <!-- icon1 -->
         ...
         <div class="d-flex justify-content-start">
            <!-- icon1  -->
            <i class="icon-size m-2 isax isax-calendar-1"></i>
            <!-- icon2  -->
            <i class="icon-size m-2 isax isax-gps"></i>
            <!-- icon3  -->
            <i class="icon-size m-2 isax isax-import-1"></i>
            <!-- icon4  -->
            <i class="icon-size blue m-2 isax isax-message-text"></i>
            <!-- icon5  -->
         ...
         <!-- Row 5 -->
         <div class="d-flex justify-content-start">
            <i class="icon-size m-2 isax isax-eye"></i>
            <!-- icon1  -->
            <i class="icon-size m-2 isax isax-eye-slash"></i>
            <!-- icon2  -->
