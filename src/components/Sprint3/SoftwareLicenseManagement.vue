       ...
       <div class="d-flex justify-content-center">
          <div class=" rounded-3 container">
             ...
             <div>
                ...
                <button class="button-tab-active">Software License Management</button>
             </div>
             <!-- row1  -->
             <div class=" shadow-sm border-round16px pb-20px pt-10px">
                   ...
                   <table class="table table-striped-custom table-hover table-responsive font-table-text table-borderless "  >
                      <thead class="table-header">
                         <tr >
                            ...
                            <th class="text-start px-20px  pb-10px padding-top-none">
                               <div class="d-flex align-items-center">
                                  <span class="font-table-column me-10px">End-of-Sale Date</span>
                                  <i class="isax isax-arrow-down5 size-icon-table-arrow"></i>
                               </div>
                            </th>
                            <th class="text-start px-20px  pb-10px padding-top-none">
                               <div class="d-flex align-items-center">
                                  <span class="font-table-column me-10px">End-of-Support-Life Date</span>
                                  <i class="isax isax-arrow-down5 size-icon-table-arrow"></i>
                               </div>
                            </th>
                            <th class="text-start px-20px  pb-10px padding-top-none">
                      ...
                      <tbody class="border rounded-1 " >
                         ...
                         <tr class="size-table-tabledata column border-rouded-5px">
                            ...
                            <td class="text-start px-20px vertical-alignment-center">01/01/2023</td>
                            <td class="text-start px-20px vertical-alignment-center">01/01/2023</td>
                            <td class="text-start px-20px vertical-alignment-center">01/01/2023</td>
                         ...
                         <tr class="size-table-tabledata column border-rouded-5px">
                            ...
                            <td class="text-start px-20px vertical-alignment-center">01/01/2023</td>
                            <td class="text-start px-20px vertical-alignment-center">01/01/2023</td>
                            <td class="text-start px-20px vertical-alignment-center">PaaS - E</td>
                            <td class="text-end px-20px p-3 vertical-alignment-center fontfamily-gotham-heading-3 ">
                               <div class="dropdown outline-none">
                                  <button class="btn padding-none border-color-none btn-hover" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                     <fa class="font-size-24px" icon="ellipsis" />
                         ...
                         <tr class="size-table-tabledata column border-rouded-5px">
                            ...
                            <td class="text-start px-20px vertical-alignment-center">01/01/2023</td>
                            <td class="text-start px-20px vertical-alignment-center">01/01/2023</td>
                            <td class="text-start px-20px vertical-alignment-center">PaaS - I</td>
                            <td class="text-end px-20px p-3 vertical-alignment-center fontfamily-gotham-heading-3 ">
                               <div class="dropdown outline-none">
                                  <button class="btn padding-none border-color-none btn-hover" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                     <fa class="font-size-24px" icon="ellipsis" />
                         ...
                         <tr class="size-table-tabledata column border-rouded-5px">
                            ...
                            <td class="text-start px-20px vertical-alignment-center">01/01/2023</td>
                            <td class="text-start px-20px vertical-alignment-center">01/01/2023</td>
                            <td class="text-start px-20px vertical-alignment-center">PaaS - B</td>
                            <td class="text-end px-20px p-3 vertical-alignment-center fontfamily-gotham-heading-3 ">
                               <div class="dropdown outline-none">
                                  <button class="btn padding-none border-color-none btn-hover" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                     <fa class="font-size-24px" icon="ellipsis" />
                ...
                <div class="d-flex flex-row justify-content-end mx-20px mt-20px font-table-pagination d-flex align-items-center ">
                   <!-- pagination  -->
                   <div class="d-flex  align-items-center">
                      <button class="button-pagination bg-none color-dimgray border-color-none btn-hover">
             ...
             <div class=" shadow-sm border-round16px pb-20px pt-10px">
                ...
                <div class="d-flex justify-content-start mt-20px mx-20px flex-container">
                    <div class="form-floating">
                        <textarea class="form-control width-max" placeholder="Leave a comment here" id="floatingTextarea2"></textarea>
