<template>
    ...
    <div class="p-header-20px ">
       ...
       <div class="mb-10px d-flex justify-content-start">
          <span class="font-table-column " > Name <i class="isax isax-arrow-down-1 size-icon-table-arrow "></i></span>
          <span class="font-table-column margin-orgid"> Org Id <i class="isax isax-arrow-down-1 size-icon-table-arrow "></i></span>
          <span class="font-table-column margin-emailaddress"> Email Address <i class="isax isax-arrow-down-1 size-icon-table-arrow "></i></span>
          <span class="font-table-column margin-organization"> Organization <i class="isax isax-arrow-down-1 size-icon-table-arrow "></i></span>
          <span class="font-table-column margin-contact"> Contact <i class="isax isax-arrow-down-1 size-icon-table-arrow "></i></span>
          <span class="font-table-column margin-tin"> Tin <i class="isax isax-arrow-down-1 size-icon-table-arrow "></i></span>
    ...
    <!-- table Header  -->
    <!-- table Body  -->
    <div class="table-responsive border border rounded-1 shadow-sm border-top" >
